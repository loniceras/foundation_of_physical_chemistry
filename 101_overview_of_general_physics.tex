...
\begin{equation*}
    \var{\action} = -mc \int_a^b \var{\sqrt{\dd{x^{\mu}} \dd{x_{\mu}}}} = -mc \int_a^b \frac{\dd{x^{\mu}} \dd{\var{x_{\mu}}}}{\dd{s}} = \eval{-mc \dv{x^{\mu}}{s} \var{x_{\mu}}}_a^b + mc \int_a^b \dd{s} \var{x_{\mu}} \dv{s} \dv{x^{\mu}}{s} = 0.
\end{equation*}
由于$ \var{x_{\mu}(a)}=\var{x_{\mu}(b)}=0 $, 得$ \eval{-mc \dv{x^{\mu}}{s} \var{x_{\mu}}}_a^b=0 $. 为了使$ \action $取极小值, $ \var{\action}=0 $. 由于$ \var{x_{\mu}} $的任意性, 得粒子的运动方程的四维协变形式
\begin{equation}
    \dv[2]{x^{\mu}}{s} = 0.
\end{equation}
...
\begin{equation*}
    \action = \sum_i -m_i c \int_a^b \dd{s}.
\end{equation*}

我们考虑狭义相对论时空观下的粒子与洛伦兹标量外场间存在相互作用时的力学量和运动方程. 与标量外场间存在相互作用的粒子的哈密顿作用量为, 拉格朗日函数, 运动方程分别为
\begin{equation*}
    \action = \int_{t_{\init}}^{t_{\fini}} \lagr \dd{t} = -mc \int_a^b \dd{s} \enum^{\varPhi(\vb*{x})}.
\end{equation*}
...
\begin{equation*}
    \action = \sum_i -m_i c \int_a^b \dd{s} \enum^{\varPhi(\vb*{x})}.
\end{equation*}
...
\begin{equation*}
    \action = \int_{t_{\init}}^{t_{\fini}} \lagr \dd{t} = -mc \int_a^b \dd{s} - \frac{e}{c} \int_a^b A_{\mu} (\vb*{x}) \dd{x^{\mu}} = - \int_a^b \bigg(mc + \frac{e}{c} v^{\mu} A_{\mu}\bigg) \dd{s}.
\end{equation*}
...
\begin{align*}
    \var{\action} &= - \var{\int_a^b \bigg(mc + \frac{e}{c} v^{\mu} A_{\mu}\bigg) \dd{s}}
    = -\int_a^b \bigg(mc v_{\mu} \dd{\var{x^{\mu}}} + \frac{e}{c} A_{\mu} \dd{\var{x^{\mu}}} + \frac{e}{c} \var{A_{\mu}} \dd{x^{\mu}}\bigg) \\
    &= \int_a^b \bigg(mc \dd{v_{\mu}} \var{x^{\mu}} + \frac{e}{c} \var{x^{\mu}} \dd{A_{\mu}} - \frac{e}{c} \var{A_{\mu}} \dd{x^{\mu}} \bigg) - \eval{\bigg(mcv_{\mu} + \frac{e}{c}A_{\mu}\bigg) \var{x^{\mu}}}_a^b\\
    &= \int_a^b \bigg(mc \dd{v_{\mu}} \var{x^{\mu}} + \frac{e}{c} \pdv{A_{\mu}}{x^{\nu}} \var{x^{\mu}} \dd{x^{\nu}} - \frac{e}{c} \pdv{A_{\mu}}{x^{\nu}} \var{x^{\nu}} \dd{x^{\mu}} \bigg) - \eval{\bigg(mcv_{\mu} + \frac{e}{c}A_{\mu}\bigg) \var{x^{\mu}}}_a^b\\
    &= \int_a^b \bigg(mc \dv{x^{\mu}}{s} + \frac{e}{c} \bigg(\pdv{A_{\mu}}{x^{\nu}} - \pdv{A_{\nu}}{x^{\mu}}\bigg) v^{\nu} \bigg) \var{x^{\mu}} \dd{s} - \eval{\bigg(mcv_{\mu} + \frac{e}{c}A_{\mu}\bigg) \var{x^{\mu}}}_a^b\\
    &= \int_a^b \bigg(mc \dv{x^{\mu}}{s} - \frac{e}{c} F_{\mu\nu} v^{\nu} \bigg) \var{x^{\mu}} \dd{s} - \eval{\bigg(mcv_{\mu} + \frac{e}{c}A_{\mu}\bigg) \var{x^{\mu}}}_a^b.
\end{align*}
由于$ \var{x_{\mu}(a)}=\var{x_{\mu}(b)}=0 $, 得$ \eval{(mcv_{\mu} + \frac{e}{c}A_{\mu}) \var{x^{\mu}}}_a^b=0 $. 为了使$ \action $取极小值, $ \var{\action}=0 $. 由于$ \var{x^{\mu}} $的任意性, 得粒子的运动方程的四维协变形式
\begin{equation}
...
\begin{align*}
    \action &= \action_{\mathrm{m}} + \action_{\mathrm{mf}} + \action_{\mathrm{f}} = - \sum_i m_i c \int_a^b \dd{s} - \sum_i \frac{e_i}{c} \int_a^b A_{\mu} (\vb*{x}) \dd{x^{\mu}} + \frac{d}{c} \int_a^b F_{\mu\nu} F^{\mu\nu} \dd[4]{x}\\
    &= - \sum_i m_i c \int_a^b \dd{s} - \frac{1}{c} \int_a^b \rho A_{\mu} (\vb*{x}) \dd{x^{\mu}} \dd{V} + \frac{d}{c} \int_a^b F_{\mu\nu} F^{\mu\nu} \dd[4]{x}\\
    &= - \sum_i m_i c \int_a^b \dd{s} -\frac{1}{c^2} \int_a^b A_{\mu} J^{\mu} \dd[4]{x} + \frac{d}{c} \int_a^b F_{\mu\nu} F^{\mu\nu} \dd[4]{x}.
\end{align*}
其中, $ d $的数值与场的测量单位有关, 在高斯单位制下$ d = -1/16 \pi $. 现在考虑矢量外场的力学量和运动方程, 矢量外场的哈密顿作用量为
\begin{equation*}
    \action = \int_{t_{\init}}^{t_{\fini}} \lagr \dd{t} = -\frac{1}{c^2} \int_a^b A_{\mu} J^{\mu} \dd[4]{x} + \frac{1}{16 \pi c} \int_a^b F_{\mu\nu} F^{\mu\nu} \dd[4]{x}.
\end{equation*}
假设场内粒子的运动是已知的, 只变分场的四维势, 我们有
\begin{align*}
    \var{\action} &= -\frac{1}{c} \var{\int_a^b \bigg(\frac{1}{c} A_{\mu} J^{\mu} + \frac{1}{16 \pi} F_{\mu\nu} F^{\mu\nu} \bigg) \dd[4]{x}}
    = -\frac{1}{c} \int_a^b \bigg(\frac{1}{c} J^{\mu}\var{A_{\mu}} + \frac{1}{16 \pi} \var{\big(F_{\mu\nu} F^{\mu\nu}\big)} \bigg) \dd[4]{x} \\
    &= -\frac{1}{c} \int_a^b \bigg(\frac{1}{c} J^{\mu}\var{A_{\mu}} + \frac{1}{8 \pi} F^{\mu\nu} \var{F_{\mu\nu}} \bigg) \dd[4]{x} = -\frac{1}{c} \int_a^b \bigg(\frac{1}{c} J^{\mu}\var{A_{\mu}} + \frac{1}{8 \pi} F^{\mu\nu} \partial_{\mu} \var{A_{\nu}} - \frac{1}{8 \pi} F^{\mu\nu} \partial_{\nu} \var{A_{\mu}} \bigg) \dd[4]{x}\\
    &= -\frac{1}{c} \int_a^b \bigg(\frac{1}{c} J^{\mu}\var{A_{\mu}} - \frac{1}{4 \pi} F^{\mu\nu} \partial_{\nu} \var{A_{\mu}} \bigg) \dd[4]{x} = -\frac{1}{c} \int_a^b \bigg(\frac{1}{c} J^{\mu} + \frac{1}{4 \pi} \pdv{F^{\mu\nu}}{x^{\nu}} \bigg) \var{A_{\mu}} \dd[4]{x} +\eval{\frac{\int_a^b F^{\mu\nu} \var{A_{\mu}} \dd{S_{\nu}}}{4\pi c}}_a^b.
\end{align*}
由于$ \var{A_{\mu}(a)}=\var{A_{\mu}(b)}=0 $, 得$ \eval{\frac{1}{4\pi c} \int_a^b F^{\mu\nu} \var{A_{\mu}} \dd{S_{\nu}}}_a^b=0 $. 为了使$ \action $取极小值, $ \var{\action}=0 $. 由于$ \var{A^{\mu}} $的任意性, 得场的运动方程的四维协变形式
\begin{equation}
    \partial_{\nu} F^{\mu\nu} = -\frac{4\pi}{c} J^{\mu}.
\end{equation}
